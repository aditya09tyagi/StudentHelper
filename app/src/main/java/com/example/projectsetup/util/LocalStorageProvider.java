...
public class LocalStorageProvider extends DocumentsProvider {
    ...
    public Cursor queryRoots(final String[] projection) throws FileNotFoundException {
        // Create a cursor with either the requested fields, or the defaultString
    ...
    public String createDocument(final String parentDocumentId, final String mimeType,
        ...
        try {
            ...
            Log.e(LocalStorageProvider.class.getSimpleName(), "ErrorModel creating new file " + newFile);
        }
        return null;
    }
    ...
    public AssetFileDescriptor openDocumentThumbnail(final String documentId, final Point sizeHint,
        ...
        try {
            ...
            Log.e(LocalStorageProvider.class.getSimpleName(), "ErrorModel writing thumbnail", e);
            return null;
        } finally {
            if (out != null)
                try {
                    ...
                    Log.e(LocalStorageProvider.class.getSimpleName(), "ErrorModel closing thumbnail", e);
                }
        }
    ...
    private void includeFile(final MatrixCursor result, final File file)
        ...
        // Document.COLUMN_ICON can be a resource rewardId identifying a custom icon.
        // The system provides defaultString icons
        // based on mime type
