package com.example.projectsetup.ui.widget.photo_view_layout;
...
import com.example.projectsetup.ui.widget.photo_view_layout.viewer.builder.BuilderData;
import com.example.projectsetup.ui.widget.photo_view_layout.viewer.dialog.ImageViewerDialog;
...
public class StfalconImageViewer<T> {
     ...
     * Displays the built viewer if passed list of images is not empty
     *
     * @param animate whether the passed transition view should be animated on open. Useful for screen wheelRotation handling.
     */
